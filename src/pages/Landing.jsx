  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-200 to-white text-gray-900">
      <div className="relative flex flex-col items-center justify-center text-center py-20 px-6">
        ...
        >
          Welcome to <span className="block">Task-Manage</span>
        </motion.h1>
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="flex gap-8">
            {[
              { name: "John Doe", text: "Task-Manage has streamlined our team's workflow!" },
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="space-y-4">
            {[
              { question: "Is Task-Manage free to use?", answer: "Yes! Task-Manage offers a free plan with core features." },
              { question: "Can I use Task-Manage for my team?", answer: "Absolutely! Task-Manage supports team collaboration." },
